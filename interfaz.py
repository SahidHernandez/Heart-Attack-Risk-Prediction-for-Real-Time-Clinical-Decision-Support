...
model_configs = {
    ...
    'Model 2': {
        'model': joblib.load('Prediction-of-Acute-Myocardial-Infarction-Risk-Using-Stacked-Machine-Learning-Models/2nd_dataset_final/ensemble_DecisionTree_dataset2.pkl'),
